...
def load_data(ticker: str):
    ...
    if os.environ.get('RUNNING_IN_DOCKER') == 'True':
        ...
        csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'LoadData/data/OPA.csv')
...
def preprocess_data(df: pd.DataFrame):
    ...
    cols_to_scale = ['Adj Close', 'Close', 'High', 'Low', 'Open', 'Volume', 'Google Trends', 'Mean']
